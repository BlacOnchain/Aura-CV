    ...
    <div className="min-h-screen bg-zinc-50/50 overflow-x-hidden selection:bg-zinc-900 selection:text-white font-body text-zinc-900 w-full max-w-full">
      ...
      <header className="fixed top-0 left-0 right-0 h-16 sm:h-20 z-50 px-4 sm:px-8 lg:px-12 flex items-center justify-between glass-surface border-x-0 border-t-0">
        ...
        <nav className="hidden md:flex items-center gap-6 text-xs font-medium text-zinc-500">
          ...
          <a href="#demo" className="hover:text-zinc-900 transition-colors">Studio Demo</a>
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button 
            ...
            className="px-4 py-2.5 bg-zinc-950 text-white rounded-xl text-xs font-semibold hover:bg-zinc-800 transition-all cursor-pointer shadow-xs flex items-center gap-1.5"
          >
      ...
      <section id="hero" className="pt-24 sm:pt-32 pb-12 sm:pb-16 px-4 sm:px-6 lg:px-12 max-w-5xl mx-auto text-center space-y-6">
        <motion.div 
        ...
        >
          ...
          <div className="pt-2 flex flex-col sm:flex-row gap-3 justify-center items-center">
            <button 
              type="button"
              onClick={() => onStart('register')}
              className="w-full sm:w-auto px-7 py-3 bg-zinc-950 hover:bg-zinc-800 text-white rounded-xl font-semibold flex items-center justify-center gap-2 shadow-sm transition-all cursor-pointer text-sm"
            >
        ...
        {/* Clean Color-Graded Studio Hero Showcase */}
      ...
      <section id="workflow" className="py-12 sm:py-16 px-4 sm:px-6 lg:px-12 max-w-6xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="bg-white p-6 rounded-2xl border border-zinc-200/90 shadow-2xs space-y-2">
            ...
            <h3 className="text-base font-bold text-zinc-900">Quantify Experience</h3>
          ...
          <div className="bg-white p-6 rounded-2xl border border-zinc-200/90 shadow-2xs space-y-2">
            ...
            <h3 className="text-base font-bold text-zinc-900">ATS Keyword Audit</h3>
            <p className="text-xs text-zinc-500 leading-relaxed">
          ...
          <div className="bg-white p-6 rounded-2xl border border-zinc-200/90 shadow-2xs space-y-2">
            ...
            <h3 className="text-base font-bold text-zinc-900">Export PDF Package</h3>
            <p className="text-xs text-zinc-500 leading-relaxed">
      ...
      {/* High-Contrast Final Call To Action */}
      <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-12 max-w-4xl mx-auto text-center">
        <div className="bg-zinc-950 text-white rounded-3xl p-8 sm:p-12 shadow-xl space-y-5 border border-zinc-800">
          ...
          <div className="pt-2 flex flex-col sm:flex-row gap-3 justify-center items-center">
            <button
              type="button"
              onClick={() => onStart('register')}
              className="w-full sm:w-auto px-7 py-3 bg-white text-zinc-950 hover:bg-zinc-100 font-bold rounded-xl text-xs sm:text-sm transition-all cursor-pointer shadow-sm"
            >
            ...
            <button
              type="button"
              onClick={() => onStart('login')}
              className="w-full sm:w-auto px-6 py-3 bg-zinc-900 hover:bg-zinc-800 text-zinc-200 border border-zinc-800 font-medium rounded-xl text-xs sm:text-sm transition-all cursor-pointer"
            >
      ...
      {/* Clean Footer */}
      <footer className="border-t border-zinc-200/80 bg-white py-8 px-4 sm:px-8 lg:px-12">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-zinc-500">
